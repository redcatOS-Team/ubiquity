...
class LanguageTests(unittest.TestCase):
    def setUp(self):
        ...
        # the Try redcatOS button with the appropriate action.
    ...
    def test_try_ubuntu_clicks(self):
        ...
        # Multiple clicks on Try redcatOS crash the installer.  LP: #911907
        self.gtk.try_ubuntu.clicked()
        self.gtk.try_ubuntu.clicked()
        # Process the clicks.
        gtkwidgets.refresh()
        # When the Try redcatOS button is clicked, the dbfilter's ok_handler()
